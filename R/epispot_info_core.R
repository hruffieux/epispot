...
#
epispot_info_core_ <- function(Y, X, V, list_hyper, gam_vb, mu_beta_vb,
  ...
  with(list_hyper, { # list_init not used with the with() function to avoid
    ...
    if (full_output) { # for internal use only
      ...
      create_named_list_(gam_vb, mat_v_mu, mu_beta_vb, mu_c0_vb, mu_c_vb, converged, it, lb_opt, diff_lb)
