...
#' Gather settings for the cross-validation procedure used in \code{epispot}.
#'
...
#'
#' vb <- epispot(Y = Y, X = X, p0_av = NULL, link = "identity", list_cv = list_cv,
#'             user_seed = seed)
#'
    ...
    evaluate_fold_ <- function(k) {
      ...
      for(ind_pg in 1:size_p0_av_grid) {
        ...
        if (link == "identity") {
          ...
          if (nq) {
            vb_tr <- epispot_core_(Y_tr, X_tr, list_hyper_pg,
            ...
            vb_tr <- epispot_z_core_(Y_tr, X_tr, Z_tr, list_hyper_pg,
          ...
          vb_tr <- epispot_probit_core_(Y_tr, X_tr, Z_tr, list_hyper_pg,
                                      list_init_pg$gam_vb, list_init_pg$mu_alpha_vb,
                                      list_init_pg$mu_beta_vb, list_init_pg$sig2_alpha_vb,
          ...
          vb_tr <- epispot_mix_core_(Y_tr, X_tr, Z_tr, ind_bin, list_hyper_pg,
                                   list_init_pg$gam_vb, list_init_pg$mu_alpha_vb,
                                   list_init_pg$mu_beta_vb, list_init_pg$sig2_alpha_vb,
                                   list_init_pg$sig2_beta_vb, list_init_pg$tau_vb,
                                   tol_cv, maxit_cv, verbose = FALSE, full_output = TRUE)
